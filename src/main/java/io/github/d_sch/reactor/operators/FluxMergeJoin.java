...
public class FluxMergeJoin {
    ...
    public static Flux<ObjectNode> mergeJoinSortedList(MergeJoinType mergeJoinType, NodeComparator comparator,
            NodePredicate predicate, Mono<List<ObjectNode>> left, Mono<List<ObjectNode>> right) {
        return mergeJoinSortedFlux(
    ...
    public static Flux<ObjectNode> mergeJoinSortedFlux(MergeJoinType mergeJoinType, NodeComparator comparator,
